...
namespace Modules\Creditcard\Policies;
...
class CreditcardPolicy extends OwnershipPolicy
{
    /**
     * @var CreditcardServiceContract $service
     */
    protected $service;

    /**
     * CreditcardPolicy constructor.
     *
     * @param CreditcardServiceContract $service
     */
